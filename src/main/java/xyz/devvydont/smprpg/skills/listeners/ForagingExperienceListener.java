    ...
    public static int getBaseExperienceForBlock(Block block) {
        ...
        int exp = switch (block.getType()) {
            ...
            case CRIMSON_STEM, WARPED_STEM, NETHER_WART_BLOCK, WARPED_WART_BLOCK, STRIPPED_CRIMSON_STEM,
                 STRIPPED_WARPED_STEM, CRIMSON_HYPHAE, WARPED_HYPHAE -> 14;

            case CHERRY_LOG, ACACIA_LOG, MANGROVE_LOG, MANGROVE_ROOTS, PALE_OAK_LOG, CHERRY_WOOD, ACACIA_WOOD, MANGROVE_WOOD, PALE_OAK_WOOD -> 12;

            case BIRCH_LOG, OAK_LOG, JUNGLE_LOG, SPRUCE_LOG, DARK_OAK_LOG, BIRCH_WOOD, OAK_WOOD, JUNGLE_WOOD, SPRUCE_WOOD, DARK_OAK_WOOD -> 10;
