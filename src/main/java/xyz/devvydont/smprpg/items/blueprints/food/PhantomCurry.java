...
public class PhantomCurry extends CustomItemBlueprint implements ISellable, IEdible {

    public PhantomCurry(ItemService itemService, CustomItemType type) {
