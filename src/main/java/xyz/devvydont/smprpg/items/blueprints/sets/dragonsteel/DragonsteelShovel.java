...
public class DragonsteelShovel extends CustomAttributeItem implements ICraftable, IBreakableEquipment {
    ...
    public static final Tool TOOL_COMP = Tool.tool()
            ...
            .addRule(Tool.rule(ToolGlobals.blockRegistry.getTag(BlockTypeTagKeys.MINEABLE_SHOVEL), 11.0f, TriState.TRUE))
            .build();

    public DragonsteelShovel(ItemService itemService, CustomItemType type) {
