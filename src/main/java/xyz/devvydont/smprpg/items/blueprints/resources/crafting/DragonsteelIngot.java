...
public class DragonsteelIngot extends CustomItemBlueprint implements ISellable, ICraftable {

    public DragonsteelIngot(ItemService itemService, CustomItemType type) {
