...
public class StrangeFiber extends CustomItemBlueprint implements ISellable, ICraftable {

    public StrangeFiber(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('s', ItemService.generate(CustomItemType.ETHEREAL_FIBER));
