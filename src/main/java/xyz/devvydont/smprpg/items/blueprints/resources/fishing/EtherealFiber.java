...
public class EtherealFiber extends CustomItemBlueprint implements ISellable, ICraftable {

    public EtherealFiber(ItemService itemService, CustomItemType type) {
    ...
    public CraftingRecipe getCustomRecipe() {
        ...
        recipe.setIngredient('f', ItemService.generate(CustomItemType.ASTRAL_FILAMENT));
    ...
    public Collection<ItemStack> unlockedBy() {
        return List.of(
                ItemService.generate(CustomItemType.ASTRAL_FILAMENT)
        );
    }
