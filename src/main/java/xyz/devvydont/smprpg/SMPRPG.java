...
public final class SMPRPG extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        services.add(new BlockLootService());  // Implements custom block drop behavior.
        ...
        generalListeners.add(new MultiBlockBreakListener());  // Fixes the vanilla bug of slimes being able to attack every tick.
