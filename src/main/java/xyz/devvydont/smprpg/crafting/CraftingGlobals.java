...
public class CraftingGlobals {
     ...
     */
    public final static RecipeChoice WOODEN_PLANKS_WILDCARD = new RecipeChoice.MaterialChoice(
            Material.OAK_PLANKS,
     ...
     */
    public final static RecipeChoice WOODEN_LOGS_WILDCARD = new RecipeChoice.MaterialChoice(
            Material.OAK_LOG,
            Material.SPRUCE_LOG,
            Material.BIRCH_LOG,
            Material.JUNGLE_LOG,
     ...
     */
    public final static RecipeChoice COBBLESTONE_WILDCARD = new RecipeChoice.MaterialChoice(
